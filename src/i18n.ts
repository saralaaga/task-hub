...
const TRANSLATIONS: Record<"en" | "zh", Record<TranslationKey, string>> &
  ...
  en: {
    ...
    taskNotesAddThinoId: "Add Thino metadata to Notes view notes",
    taskNotesAddThinoIdDesc:
      "When you create a standalone note from the Task Hub Notes view, also write Thino id, createdAt, and updatedAt frontmatter so Thino multi-file can index it.",
  ...
  zh: {
    ...
    taskNotesAddThinoId: "给笔记视图中的笔记写入 Thino 元数据",
    taskNotesAddThinoIdDesc:
      "当你在 Task Hub 的笔记视图中新建普通笔记时，也写入 Thino 的 id、createdAt、updatedAt frontmatter，让 Thino multi-file 可以检索到这篇笔记。",
