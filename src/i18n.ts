...
const JA_SETTINGS_TRANSLATIONS: Partial<Record<TranslationKey, string>> = {
  ...
  localAppleCalendarDefaultTimedTaskDurationDesc: "Vault タスクを日ビューまたは週ビューの時間グリッドへドラッグしたときに使う分数。既定は 60 です。",
...
const FR_SETTINGS_TRANSLATIONS: Partial<Record<TranslationKey, string>> = {
  ...
  localAppleCalendarDefaultTimedTaskDurationDesc: "Nombre de minutes utilisé lorsqu'une tâche du coffre est déposée dans la grille horaire jour ou semaine. Par défaut : 60.",
...
const KO_SETTINGS_TRANSLATIONS: Partial<Record<TranslationKey, string>> = {
  ...
  localAppleCalendarDefaultTimedTaskDurationDesc: "vault 작업을 일 보기 또는 주 보기 시간 그리드로 드래그할 때 사용할 분 단위 길이입니다. 기본값은 60입니다.",
